...
if (!empty($_POST['login']) && !empty($_POST['password'])) {
  ...
  if ($login == 'admin' && $password == 'admin') {
    ...
    $mensagem = "<p class='success animate__animated animate__fadeIn'>Login efetuado com sucesso! Redirecionando em 3 segundos...</p>";

    // JavaScript para redirecionar após 3 segundos
    echo "<script>
                setTimeout(function() {
                    window.location.href = 'ficha_cadastro.php';
